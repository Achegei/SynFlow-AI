...
<div class="flex">
    ...
    <div class="flex-1 p-8 bg-white text-gray-900">
        <div class="max-w-4xl mx-auto">
                        ...
                        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                            ...
                            <div class="p-6 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <h3 class="text-xl font-semibold text-gray-800">Navigating the Docs</h3>
                                </div>
                                <p class="mt-4 text-gray-600">
                                    Use the sidebar to browse categories like **Technology Stack** and **AI Agents**. For specific information, use the search bar<class="px-2 py-1 text-xs font-mono text-gray-800 bg-gray-200 rounded-md"></kbd>.
                                </p>
                            </div>
                            ...
                            <div class="p-6 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <h3 class="text-xl font-semibold text-gray-800">Who This Is For</h3>
                                </div>
                                <p class="mt-4 text-gray-600">
                            ...
                            <div class="p-6 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <h3 class="text-xl font-semibold text-gray-800">How to Work With Us</h3>
                                </div>
                                <p class="mt-4 text-gray-600">
            ...
            <section class="mt-12 text-center max-w-3xl mx-auto">
                <h2 class="text-3xl font-bold text-gray-900">Tips & Feedback</h2>
                <p class="mt-4 text-lg text-gray-600">
