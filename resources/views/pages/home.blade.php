...
<section class="relative min-h-screen bg-[#050816] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
    ...
    <div class="relative z-10 max-w-5xl text-center">
        ...
        <div class="mt-8 flex justify-center gap-4 flex-wrap">
            ...
            <a href="{{ route('ai.onboarding.step', ['step' => 1]) }}" class="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold rounded-2xl shadow-[0_0_40px_rgba(99,102,241,0.35)]hover:scale-[1.03] hover:shadow-[0_0_60px_rgba(99,102,241,0.45)]
            transition-all duration-300">
                Enroll Now
            </a>
        </div>
