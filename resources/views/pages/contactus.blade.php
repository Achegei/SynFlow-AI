    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div class="max-w-lg">
            ...
            <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">
                Book a sales call with MooseLoon AI
            </h2>

            <p class="mt-4 text-lg text-gray-600">
                Tailor MooseLoon AI to your business needs with expert help. Turn conversations into leads, sales and customer loyalty with VoIP, chat and AI.
            </p>

            <div class="mt-8 space-y-6">

                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-indigo-100 text-indigo-600 flex items-center justify-center rounded-lg">⚡</div>
                    <p class="text-gray-700">
                        Connect WhatsApp Business App or API, Messenger, Instagram, Telegram and more
                    </p>
                </div>
                ...
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-indigo-100 text-indigo-600 flex items-center justify-center rounded-lg">👥</div>
                    <p class="text-gray-700">
                        Collaborate with multiple users in a shared inbox
                    </p>
                </div>
                ...
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-indigo-100 text-indigo-600 flex items-center justify-center rounded-lg">📢</div>
                    <p class="text-gray-700">
                        Run ads and send broadcasts — then let AI handle replies
                    </p>
                </div>
                ...
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-indigo-100 text-indigo-600 flex items-center justify-center rounded-lg">🤖</div>
                    <p class="text-gray-700">
                        Manage high volumes of chats and tasks with AI and automation
                    </p>
                </div>
                ...
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-indigo-100 text-indigo-600 flex items-center justify-center rounded-lg">🔗</div>
                    <p class="text-gray-700">
                        Sync existing tools and CRMs - leverage native HubSpot and Salesforce integrations
                    </p>
                </div>
        ...
        <!-- RIGHT SIDE (YOUR ORIGINAL FORM — UNTOUCHED) -->
