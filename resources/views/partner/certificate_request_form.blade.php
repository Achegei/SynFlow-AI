...
<div class="container mx-auto p-6">
    ...
    <div class="max-w-lg mx-auto bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
        ...
        <form action="{{ route('partner.certificate.request.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <button type="submit" 
                    class="w-full bg-green-500 hover:bg-green-600 transition-colors text-white font-semibold py-3 rounded-lg shadow-md hover:shadow-lg">
                Submit Request
            </button>
        </form>
    </div>
