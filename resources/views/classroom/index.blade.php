                    ...
                    <div class="mt-4">
                        ...
                        @else
                            ...
                            <form action="{{ route('purchase.course', $course->id) }}" method="POST">
                                @csrf
                                <button type="submit"
                                        class="inline-block w-full text-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200 onclick="this.innerText='Redirecting…'; this.disabled=true;">
